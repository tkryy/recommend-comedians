...
export default function Add_data() {
  ...
  const renderRatingSliders = (
    ...
    return (
      <div className="mt-12 min-w-[400px] z-10 space-y-8">
        {/* 質問のタイトル */}
        <div className="">
        ...
        <div className=" flex items-center justify-center">
          <div className="flex justify-between flew-2/3">
            <p className="text-xl w-[70px]">{leftLabel}</p>
            <div>
              <input
                type="range"
                min={0}
                max={10}
                className="w-[400px] h-2 accent-[#262526] bg-gradient-to-r from-pink-400 to-cyan-400 rounded-lg appearance-none cursor-pointer"
              ></input>
            ...
            <p className="text-xl w-[70px] text-end">{rightLabel}</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="container ">
      ...
      <div className="space-y-9">
        <h2 className="text-3xl font-bold">基本情報</h2>
        <input
          type="text"
        ...
        <h2 className="text-3xl font-bold">分析データ</h2>
        <div className="mx-12">

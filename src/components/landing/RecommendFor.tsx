...
export const RecommendFor = () => {
  return (
    <div className="flex justify-center md:pt-24">
      ...
      <p className="md:text-xl text-black md:mt-8 mt-4 md:ml-16 ml-12 md:w-full">Tendonは、最近芸人を推しはじめたひと、たくさんを芸人を知りたい人など<br className="md:block hidden"></br>お笑いが好きな人はもちろん、お笑いに少しでも興味がある人にもおすすめです。</p>
